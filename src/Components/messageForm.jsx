    ...
    return (
        <>
            {props.align != 'ups' ?
                <form className='row text-start'>
                    <section className='col-xl-6 col-lg-6 col-md-12 col-sm-12'>
                        <div className='w-100 my-3'>
                            <h6 className='fw-bold'>{t('fName')}</h6>
                        ...
                        <div className='w-100 my-3'>
                            <h6 className='fw-bold'>{t('phoneNo')}</h6>
                        ...
                        <div className='w-100 my-3'>
                            <h6 className='fw-bold'>{t('mail')}</h6>
                    ...
                    <section className='col-xl-6 col-lg-6 col-md-12 col-sm-12'>
                        <div className="my-3">
                            <h6 className='fw-bold'>{t('message')}</h6>
                ...
                </form> : <form className='text-start'>
